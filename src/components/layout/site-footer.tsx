  ...
  return (
    <footer className="border-t border-sidebar-border bg-sidebar text-sidebar-foreground">
      <div className="mx-auto grid max-w-7xl gap-10 px-4 py-12 sm:px-6 md:grid-cols-3 lg:px-8">
        <div><Link to="/" aria-label={`${siteConfig.name} home`} className="inline-block"><MillenniumLogo className="w-72 max-w-full" /></Link><p className="mt-4 max-w-sm text-sm leading-6 text-sidebar-foreground/70">{siteConfig.description}</p></div>
