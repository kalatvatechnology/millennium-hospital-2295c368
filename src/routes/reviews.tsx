...
export const Route = createFileRoute("/reviews")({
  head: () => ({
    meta: createPageMeta(
      "Patient reviews",
      "Read verified patient experiences from The Millennium Hospital.",
    ),
  }),
  ...
  return (
    <PublicPage>
      <PageIntro
        ...
        description="Only reviewed and approved patient experiences are shown here."
      />
      <ContentSection>
        <Async
          query={reviews}
          ...
          empty={
            <EmptyState
              ...
              description="Verified patient feedback will appear here once it is approved."
            />
          }
        >
          {(data) => {
              ...
              <div className="grid gap-14">
                {hospitalReviews.length ? (
                  <section aria-labelledby="hospital-reviews-title">
                    <h2 id="hospital-reviews-title" className="text-2xl font-semibold">
                      Hospital reviews
                    </h2>
                ...
                {doctorReviews.length ? (
                  <section aria-labelledby="doctor-reviews-title">
                    <h2 id="doctor-reviews-title" className="text-2xl font-semibold">
                      Doctor reviews
                    </h2>
                    <div className="mt-6 grid gap-6 md:grid-cols-2">
