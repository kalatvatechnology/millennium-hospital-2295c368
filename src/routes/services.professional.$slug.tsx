...
export const Route = createFileRoute("/services/professional/$slug")({
  head: () => ({
    meta: createPageMeta(
      ...
      "View a professional service at The Millennium Hospital.",
    ),
  }),
                ...
                <div className="grid items-start gap-10 lg:grid-cols-[minmax(0,1.45fr)_minmax(18rem,0.55fr)]">
                  <div>
                    ...
                    <p className="mt-6 max-w-3xl text-lg leading-8 text-muted-foreground">
                      {data.service.summary ?? "Further service information is being prepared."}
                    </p>
                    <Button asChild className="mt-8">
                      <a href="#service-enquiry">
                        Ask about this service <ArrowDown />
                      </a>
                    </Button>
                  </div>
                  <aside className="border-t-4 border-primary bg-secondary p-6 shadow-[var(--shadow-md)]">
                    ...
                    <p className="mt-3 leading-7 text-muted-foreground">
                      This experience focuses on patient education, related clinicians and
                      department context.
                    </p>
                  </aside>
                </div>
              ...
              <ContentSection muted>
                <div className="max-w-4xl">
                  ...
                  <p className="mt-5 whitespace-pre-line leading-8 text-muted-foreground">
                    {data.service.description ?? "Detailed information has not yet been published."}
                  </p>
                </div>
                <div className="mt-10 grid gap-5 md:grid-cols-2">
                  <div className="bg-card p-6 shadow-[var(--shadow-sm)]">
                    <ClipboardCheck className="text-primary" />
                    <h3 className="mt-4 text-xl font-semibold">Assessment and planning</h3>
                    <p className="mt-3 leading-7 text-muted-foreground">
                      Approved CMS content can explain preparation, treatment pathways and
                      follow-up.
                    </p>
                  </div>
                  <div className="bg-card p-6 shadow-[var(--shadow-sm)]">
                    <HeartHandshake className="text-primary" />
                    <h3 className="mt-4 text-xl font-semibold">Informed decisions</h3>
                    <p className="mt-3 leading-7 text-muted-foreground">
                      Information can balance potential benefits, considerations and alternatives
                      without guarantees.
                    </p>
                  </div>
                </div>
              ...
              <ContentSection>
                <div id="service-enquiry" className="mx-auto max-w-2xl scroll-mt-24">
                  <EnquiryForm
                    ...
                    title={`Ask about ${data.service.title}`}
